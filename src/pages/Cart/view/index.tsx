...
import GuessLikeCards from './Cards'
      ...
      <>
         <div className={style.shoppingCart}>
            ...
            <div className={style.cards}>
               <GuessLikeCards allLikeCards={props.store.allLikeCards} positon={0} />
               <GuessLikeCards allLikeCards={props.store.allLikeCards} positon={1} />
            </div>
         </div>
